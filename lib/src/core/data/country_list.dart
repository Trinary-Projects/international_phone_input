...
/// [Countries] has a static method [countryList] that returns list of Map for
/// most country around the world.
class Countries {
  ...
  static final List<Map<String, dynamic>> _countryList = <Map<String, dynamic>>[
    {
      'num_code': '4',
      'alpha_2_code': 'AF',
      'alpha_3_code': 'AFG',
